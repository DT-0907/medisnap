      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            role="combobox"
            aria-expanded={open}
            className="w-full justify-between h-14 bg-white border border-gray-300 rounded-lg text-base font-medium hover:bg-gray-50 shadow-sm"
          >
            {selectedPatient ? (
        ...
        <PopoverContent className="w-[600px] p-0 bg-white border border-gray-200 rounded-lg shadow-lg z-50" align="start">
          <Command>
            <CommandInput
